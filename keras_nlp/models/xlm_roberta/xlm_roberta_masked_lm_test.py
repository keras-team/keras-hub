...
class XLMRobertaMaskedLMTest(tf.test.TestCase, parameterized.TestCase):
    ...
    def test_xlm_roberta_masked_lm_predict(self, jit_compile):
    ...
    def test_xlm_roberta_masked_lm_predict_no_preprocessing(self, jit_compile):
    ...
    def test_xlm_roberta_masked_lm_fit(self, jit_compile):
    ...
    def test_xlm_roberta_masked_lm_fit_no_preprocessing(self, jit_compile):
