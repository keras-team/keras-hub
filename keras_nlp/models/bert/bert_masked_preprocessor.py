...
from keras_nlp.models.bert.bert_multi_segment_packer import (
    BertMultiSegmentPacker,
)
...
class BertPreprocessor(Preprocessor):
    """BERT preprocessing layer which tokenizes and packs inputs.
    ...
    Args:
        tokenizer: A `keras_nlp.models.BertaTokenizer` instance.
    ...
    preprocessor = keras_nlp.models.BertaPreprocessor.from_preset(
        "bert_base_en",
    )
    ...
    tokenizer = keras_nlp.models.BertaTokenizer(
        vocabulary=vocab,
        merges=merges,
    )
    preprocessor = keras_nlp.models.BertaPreprocessor(
        tokenizer=tokenizer,
        sequence_length=8,
    )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.packer = BertMultiSegmentPacker(
