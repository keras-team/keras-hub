...
class FnetClassifierTest(tf.test.TestCase, parameterized.TestCase):
    ...
    def test_f_net_classifier_predict(self, jit_compile):
    ...
    def test_f_net_classifier_predict_no_preprocessing(self, jit_compile):
    ...
    def test_f_net_classifier_fit(self, jit_compile):
    ...
    def test_f_net_classifier_fit_no_preprocessing(self, jit_compile):
