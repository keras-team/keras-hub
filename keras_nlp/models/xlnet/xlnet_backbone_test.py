...
class XLNetBackboneTest(tf.test.TestCase, parameterized.TestCase):
    def setUp(self):
        self.model = XLNetBackbone(
    ...
    def test_valid_call_xlnet(self):
        ...
        self.assertRegexpMatches(self.model.name, "xlnet_backbone")
...
class XLNetBackboneTPUTest(tf.test.TestCase, parameterized.TestCase):
    def setUp(self):
