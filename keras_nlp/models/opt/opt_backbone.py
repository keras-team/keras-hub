...
class OPTBackbone(Backbone):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Embed tokens, potentially at a lower dimensionality.
        ...
        # Project tokens to the hidden_dim in necessary.
        if embedding_dim != hidden_dim:
            token_embedding = keras.layers.Dense(
                hidden_dim,
                kernel_initializer=opt_kernel_initializer(),
                use_bias=False,
                name="embedding_projection",
            )(token_embedding)
        # Embed positions as the hidden_dim.
        position_embedding = PositionEmbedding(
            initializer=opt_kernel_initializer(),
        ...
        # Project final representation back to embedding_dim if necessary.
        if embedding_dim != hidden_dim:
