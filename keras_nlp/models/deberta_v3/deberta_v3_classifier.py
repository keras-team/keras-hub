...
DebertaV3Classifier.from_preset.__func__.__doc__ = Task.from_preset.__doc__
format_docstring(
    model_task_name=DebertaV3Classifier.__name__,
    example_preset_name="deberta_v3_base_en",
    preset_names=PRESET_NAMES,
)(DebertaV3Classifier.from_preset.__func__)
