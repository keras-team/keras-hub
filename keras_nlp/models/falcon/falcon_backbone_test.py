...
"""Test for Falcon backbone models."""
...
class FalconTest(tf.test.TestCase, parameterized.TestCase):
    def setUp(self):
        # For DTensor.
    ...
    def test_valid_call_Falcon(self):
    ...
    def test_name(self):
        ...
        self.assertRegexpMatches(self.backbone.name, "Falcon_backbone")

    def test_variable_sequence_length_call_Falcon(self):
    ...
    def test_saved_model(self, save_format, filename):
        ...
        self.assertIsInstance(restored_model, FalconBackbone)
    ...
    def test_create_layout_map(self):
        ...
        with FalconBackbone.create_layout_map(mesh).scope():
            FalconBackbone(
                vocabulary_size=10,
                num_layers=2,
                num_heads=2,
...
class FalconBackboneTPUTest(tf.test.TestCase, parameterized.TestCase):
    def setUp(self):
