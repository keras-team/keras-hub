...
"""Whisper AudioToSpeech LM preprocessor layer."""
...
@keras_nlp_export("keras_nlp.models.WhisperAudioToSpeechLMPreprocessor")
class WhisperAudioToSpeechLMPreprocessor(WhisperPreprocessor):
    ...
    def call(self, x, y=None, sample_weight=None):
        if y is not None or sample_weight is not None:
            logging.warning(
                "`WhisperAudioToSpeechLMPreprocessor` infers `y` and `sample_weight` "
