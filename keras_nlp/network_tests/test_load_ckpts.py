...
class BertCkptTest(tf.test.TestCase, parameterized.TestCase):
    @parameterized.named_parameters(
        ("bert_uncased_en", keras_nlp.models.BertTiny, "uncased_en"),
        ("bert_uncased_en", keras_nlp.models.BertSmall, "uncased_en"),
        ("bert_uncased_en", keras_nlp.models.BertMedium, "uncased_en"),
