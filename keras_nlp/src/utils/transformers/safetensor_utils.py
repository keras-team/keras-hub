...
def set_keras_weights(
    ...
    if reshape_patterns is None:
        reshape_patterns = [reshape_patterns] * len(hf_weight_keys)

    if transpose_patterns is None:
        transpose_patterns = [transpose_patterns] * len(hf_weight_keys)
