...
from keras_nlp.src.bounding_box import mask_invalid_detections
...
class MaskInvalidDetectionsTest(TestCase):
    def test_correctly_masks_based_on_max_dets(self):
        ...
        result = mask_invalid_detections.mask_invalid_detections(bounding_boxes)
    ...
    def test_ragged_outputs(self):
        ...
        result = mask_invalid_detections.mask_invalid_detections(
