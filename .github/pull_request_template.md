<!--- Before opening a PR, please read the updated Keras PR contribution
      policy: https://github.com/keras-team/shared-workflows/blob/main/docs/pr_policy.md
...
- [ ] I have read and followed the [PR contribution policy](https://github.com/keras-team/shared-workflows/blob/main/docs/pr_policy.md).
