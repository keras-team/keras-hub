...
def save_safetensors_streaming(weights_factory, path):
    ...
    with open(path, "wb") as f:
        ...
        for key, tensor in weights_iter:
            ...
            # For bfloat16, we might need special handling if numpy doesn't support it
            # But Keras usually handles it.
            ...
            # Keras backend `convert_to_numpy` might return float32 for bfloat16?
