...
def convert_backbone_config(transformers_config):
    # Older BLOOM checkpoints on the Hub (e.g. `bigscience/bloom-560m`) use
    # `n_embed`/`num_attention_heads`, while newer configs use
    # `hidden_size`/`n_head`. Support both spellings.
