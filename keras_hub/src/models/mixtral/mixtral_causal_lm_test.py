...
class MixtralCausalLMTest(TestCase):
    def setUp(self):
        self.preprocessor = MixtralCausalLMPreprocessor(
            MixtralTokenizer(
    ...
    @pytest.mark.xfail(
        ...
        strict=False,
        reason=(
            "Upstream litert-torch limitation: Mixtral's MoE routing emits "
