...
@keras_hub_export("keras_hub.layers.Gemma4UnifiedVideoConverter")
class Gemma4UnifiedVideoConverter(VideoConverter):
    """Video converter for Gemma4 Unified model.
    ...
    Args:
        ...
        num_frames: int. Number of frames to uniformly sample from the video.
            Defaults to `32`.
        image_converter: A `Gemma4UnifiedImageConverter` instance to use for
            per-frame processing. If `None` (default), one is created
            automatically.
    """
