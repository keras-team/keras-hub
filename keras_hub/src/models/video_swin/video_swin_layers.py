...
class MLP(keras.layers.Layer):
    ...
    Args:
        ...
        dropout_rate: float. Float between 0 and 1. Fraction of the
            input units to drop.
...
class VideoSwinPatchingAndEmbedding(keras.layers.Layer):
    ...
    Args:
        ...
        norm_layer : keras.layers. Normalization layer. Default: None
...
class VideoSwinWindowAttention(keras.Model):
    ...
    Args:
        ...
        proj_drop_rate : float. Dropout ratio of output. Default: 0.0
...
class VideoSwinTransformerLayer(keras.layers.Layer):
    ...
    Args:
        ...
        norm_layer : keras.layers. norm layer Default: LayerNormalization
        downsample : keras.layers. Downsample layer at the end of the layer. Default: None
...
class VideoSwinTransformerBlock(keras.Model):
    ...
    Args:
        ...
        attn_drop : float. Attention dropout rate. Default: 0.0
        drop_path : float. Stochastic depth rate. Default: 0.0
        act_layer : keras.layers.Activation. Activation layer. Default: gelu
        norm_layer: keras.layers. Normalization layer.
            Default: LayerNormalization
