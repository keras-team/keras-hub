...
class Qwen3_5MoeCausalLM(CausalLM):
    ...
    Args:
        backbone: A ``keras_hub.models.Qwen3_5MoeBackbone`` instance.
        preprocessor: A ``keras_hub.models.Qwen3_5MoeCausalLMPreprocessor``
            or ``None``.
    """

    backbone_cls = Qwen3_5MoeBackbone
    preprocessor_cls = Qwen3_5MoeCausalLMPreprocessor
    ...
    def call_with_cache(
        ...
        Args:
            ...
            vision_indices: Optional int tensor for scattering vision tokens.
