...
class MultimodalRotaryEmbedding(RotaryEmbedding):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # This will be validated against head_dim when build() is
        # called in parent attention layer
    ...
    def apply_multimodal_rotary_embedding(self, query, key, position_ids):
        ...
        # Compute frequency matrices for all 3 dimensions using
        # same inverse_freq but different position IDs.
        # Shape: (3, batch, seq_len, head_dim_half)
    ...
    def _apply_interleaved_mrope(self, freqs, mrope_section):
        ...
        Reference:
            ...
            Qwen3OmniMoeThinkerTextRotaryEmbedding.apply_interleaved_mrope
        """
        ...
        # For each position, determine which source to use
        # Pattern: pos%3==0 -> text, pos%3==1 -> temporal,
        # pos%3==2 -> spatial
        result_slices = []
        pos = 0
