...
class EfficientNetImageClassifier(ImageClassifier):
    # TODO: update this for efficientnet
    """EfficientNet image classifier task model.

    Args:
        backbone: A `keras_hub.models.EfficientNetBackbone` instance.
    ...
    classifier = keras_hub.models.EfficientNetImageClassifier.from_preset("resnet50")
    ...
    ```python
    classifier = keras_hub.models.EfficientNetNetImageClassifier.from_preset("resnet50")
    classifier.compile(
