...
class Llama31RotaryEmbedding(RotaryEmbedding):
    """Rotary positional encoding layer.
        ...
        Args:
            max_wavelength: int. The maximum angular wavelength of the
            sine/cosine curves.
    ...
    s
        Call arguments:
            inputs: The tensor inputs to apply the embedding to. This can have
                any shape, but must contain both a sequence and feature axis.
                The rotary embedding will be applied to `inputs` and returned.
        ...
        tensor = np.ones((batch_size, sequence_length,
                          num_heads, feature_length))
        tensor_rot = rot_emb_layer(tensor)
        ```
