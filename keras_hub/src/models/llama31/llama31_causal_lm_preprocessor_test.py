...
class Llama31CausalLMPreprocessorTest(TestCase):
    def setUp(self):
        ...
        self.tokenizer = Llama31Tokenizer(
    ...
    def test_preprocessor_basics(self):
        self.run_preprocessor_test(
            cls=Llama31CausalLMPreprocessor,
    ...
    def test_with_start_end_token(self):
        ...
        preprocessor = Llama31CausalLMPreprocessor(
            **self.init_kwargs,
    ...
    def test_generate_preprocess(self):
        ...
        preprocessor = Llama31CausalLMPreprocessor(**self.init_kwargs)
    ...
    def test_all_presets(self):
        for preset in Llama31CausalLMPreprocessor.presets:
