...
from keras_hub.src.models.v2.causal_lm_preprocessor import CausalLMPreprocessor
from keras_hub.src.tests.test_case import TestCase


class TestCausalLMPreprocessor(TestCase):
    def test_preset_accessors(self):
        self.skipTest("Enable once v2.causal_lm_preprocessor is default.")
    ...
    def test_from_preset_errors(self):
        with self.assertRaises(ValueError):
            ...
            CausalLMPreprocessor.from_preset("bert_tiny_en_uncased")
        with self.assertRaises(ValueError):
            # No loading on a non-keras model.
            CausalLMPreprocessor.from_preset("hf://spacy/en_core_web_sm")
    ...
    def test_export_missing_tokenizer(self):
        preprocessor = CausalLMPreprocessor(tokenizer=None)
