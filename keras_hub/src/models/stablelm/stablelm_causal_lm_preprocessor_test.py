...
class StableLMCausalLMPreprocessorTest(TestCase):
    def setUp(self):
        ...
        self.tokenizer = StableLMTokenizer(
    ...
    def test_preprocessor_basics(self):
        self.run_preprocessor_test(
            cls=StableLMCausalLMPreprocessor,
            init_kwargs=self.init_kwargs,
            input_data=self.input_data,
            expected_output=(
                {
                    "token_ids": [[1, 25, 16, 26, 25, 18, 1, 0]],
                    "padding_mask": [[1, 1, 1, 1, 1, 1, 1, 0]],
                },
                [[25, 16, 26, 25, 18, 1, 0, 0]],  # Pass through labels.
    ...
    def test_no_start_end_token(self):
        ...
        self.assertAllEqual(x["token_ids"], [[25, 16, 26, 25, 18, 0, 0, 0]] * 4)
    ...
    def test_generate_preprocess(self):
        ...
        self.assertAllEqual(x["token_ids"], [1, 25, 16, 26, 25, 18, 0, 0])
        self.assertAllEqual(x["padding_mask"], [1, 1, 1, 1, 1, 1, 0, 0])

    def test_generate_postprocess(self):
        input_data = {
            "token_ids": ops.array([1, 25, 16, 26, 25, 18, 0, 0]),
