...
def t5gemma2_kernel_initializer(initializer_range=0.01):
    """Creates a RandomNormal initializer for T5Gemma2 kernels.
...
class T5Gemma2MLP(keras.layers.Layer):
    """Multilayer Perceptron (MLP) block for the T5Gemma2 model.

    This layer implements the feed-forward part of a transformer block,
    consisting of a gated GELU activation and dropout, following the
    Gemma3 architecture pattern.
