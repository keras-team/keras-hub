...
from keras_hub.src.models.phi4.phi4_attention import Phi4Attention
from keras_hub.src.models.phi4.phi4_layernorm import Phi4LayerNorm
from keras_hub.src.utils.keras_utils import clone_initializer


class Phi4Decoder(keras.layers.Layer):
    """A Transformer decoder layer for the Phi-4 backbone."""
    ...
    def build(self, decoder_sequence_shape):
        ...
        self.pre_attention_layernorm = Phi4LayerNorm(
        ...
        self.post_attention_layernorm = Phi4LayerNorm(
            epsilon=self.layer_norm_epsilon,
            dtype=self.dtype_policy,
