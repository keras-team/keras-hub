...
register_presets(backbone_presets, Qwen3ASRTokenizer)
register_presets(backbone_presets, Qwen3ASRCausalLMPreprocessor)
register_presets(backbone_presets, Qwen3ASRCausalLM)
