...
backbone_presets = {
    "inception_v1_imagenet": {
        "metadata": {
            "description": (
                "InceptionV1 (GoogLeNet) model pre-trained on the ImageNet 1k "
    ...
    "inception_v3_imagenet": {
        "metadata": {
            "description": (
                ...
                "at a 299x299 resolution. Features factorized convolutions "
                "and improved pooling strategies."
            ),
            "params": 23851784,
            "path": "inception",
        },
    ...
    "inception_resnet_v2_imagenet": {
        "metadata": {
            "description": (
                "Inception-ResNet-v2 hybrid model pre-trained on the ImageNet "
                "1k dataset at a 299x299 resolution. Combines Inception "
    ...
    "inception_resnet_v2_transfer_imagenet": {
        "metadata": {
            "description": (
                "Inception-ResNet-v2 hybrid model pre-trained on the ImageNet "
                "1k dataset at a 299x299 resolution with transfer learning "
