...
backbone_presets = {
    ...
    "qwen3_4b_en": {
        "metadata": {
            "description": (
                ...
                "reasoning capabilities and better performance than smaller variants."
            ),
            "params": 4022468096,
            "path": "qwen-3",
        },
    ...
    "qwen3_8b_en": {
        "metadata": {
            "description": (
                "36-layer Qwen3 model with 8.19B parameters, featuring enhanced "
                "reasoning, coding, and instruction-following capabilities."
            ),
            "params": 8190735360,
            "path": "qwen-3",
        },
    ...
    "qwen3_14b_en": {
        "metadata": {
            "description": (
                "40-layer Qwen3 model with 14.77B parameters, featuring advanced "
                "reasoning, coding, and multilingual capabilities."
            ),
            "params": 14768307200,
            "path": "qwen-3",
        },
    ...
    "qwen3_32b_en": {
        "metadata": {
            "description": (
                "64-layer Qwen3 model with 32.76B parameters, featuring state-of-the-art "
                "performance across reasoning, coding, and general language tasks."
            ),
            "params": 32762123264,
            "path": "qwen-3",
        },
