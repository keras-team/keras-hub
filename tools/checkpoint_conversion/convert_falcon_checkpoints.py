...
from keras_nlp.models import FalconBackbone
from keras_nlp.models import FalconTokenizer

PRESET_NAME = "falcon-7b"
BASE_MODEL = ""
PRESET = ""
EXTRACT_DIR = "./{}"
...
hf_model = FalconModel.from_pretrained(PRESET)
hf_model.eval()
...
keras_tokenizer = FalconTokenizer(vocabulary=vocab_path, merges=merges_path)
