...
def convert_modernbert_weights(keras_model, hf_model):
...
def convert_modernbert_masked_lm_weights(keras_lm, backbone, hf_model):
    """Maps HF MaskedLM head weights to Keras ModernBertMaskedLM."""
    print("Converting MaskedLM Head Weights...")
    convert_modernbert_weights(backbone, hf_model)
...
def main(preset, output_dir):
    ...
    convert_modernbert_masked_lm_weights(keras_lm, backbone, hf_model)
