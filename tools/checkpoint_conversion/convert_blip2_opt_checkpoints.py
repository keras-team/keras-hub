"""
Convert BLIP-2 opt checkpoints to KerasHub format.
...
def validate_opt(
    ...
    print_header("OPT (LANGUAGE MODEL) VALIDATION")
...
def validate_output(
    ...
    print_header("FULL PIPELINE — FORWARD PASS")
    ...
    report_diff("Full pipeline logits", keras_text_logits, hf_text_logits)
