...
from keras_hub.src.models import Phi4Backbone  # noqa: E402
from keras_hub.src.models import Phi4Preprocessor  # noqa: E402
from keras_hub.src.models import Phi4Tokenizer  # noqa: E402

PRESET_MAP = {
    "phi4_mini_4k_instruct_en": "microsoft/Phi-4-mini-4k-instruct",
    "phi4_mini_instruct_en": "microsoft/Phi-4-mini-instruct",
}
...
def convert_tokenizer(hf_model_dir):
    ...
    tokenizer = Phi4Tokenizer(model_proto.SerializeToString())
...
def convert_model(hf_model, device, dtype):
    ...
    with keras.device(device):
        keras_model = Phi4Backbone(**kwargs)
...
def main():
    ...
    parser.add_argument(
        "--preset",
        default="phi4_mini_4k_instruct_en",
    ...
    keras_preprocessor = Phi4Preprocessor(
        tokenizer=keras_tokenizer, sequence_length=9
    )
    # phi4 uses llama tokenizer
